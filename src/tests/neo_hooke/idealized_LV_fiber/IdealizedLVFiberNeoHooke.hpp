/**
 * @file IdealizedLVFiberNeoHooke.hpp
 * @brief Header file defining the idealized lv solver class.
 */

#ifndef IDEALIZED_LV_FIBER_NEO_HOOKE_HPP
#define IDEALIZED_LV_FIBER_NEO_HOOKE_HPP
...
/**
 * @class IdealizedLVFiberNeoHooke
 * @brief Class representing the an Idealized LV solver with active fiber
 * contraction
 */
template <int dim, typename Scalar>
class IdealizedLVFiberNeoHooke : public BaseSolverNeoHooke<dim, Scalar> {
  /**
...
public:
   ...
   */
  IdealizedLVFiberNeoHooke(const std::string &parameters_file_name_,
...
template <int dim, typename Scalar>
Scalar IdealizedLVFiberNeoHooke<dim, Scalar>::Ellipsoid::epi_r_l;

template <int dim, typename Scalar>
Scalar IdealizedLVFiberNeoHooke<dim, Scalar>::Ellipsoid::epi_r_s;

template <int dim, typename Scalar>
Scalar IdealizedLVFiberNeoHooke<dim, Scalar>::Ellipsoid::endo_r_l;

template <int dim, typename Scalar>
Scalar IdealizedLVFiberNeoHooke<dim, Scalar>::Ellipsoid::endo_r_s;

#endif // IDEALIZED_LV_FIBER_NEO_HOOKE_HPP
