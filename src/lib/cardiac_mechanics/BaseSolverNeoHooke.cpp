...
void BaseSolverNeoHooke<dim, Scalar>::setup() {
  // Create the mesh.
  {
 ...
 */
template <int dim, typename Scalar>
void BaseSolverNeoHooke<dim, Scalar>::compute_piola_kirchhoff(
 ...
 */
template <int dim, typename Scalar>
void BaseSolverNeoHooke<dim, Scalar>::assemble_system() {
 ...
 */
template <int dim, typename Scalar>
unsigned BaseSolverNeoHooke<dim, Scalar>::solve_system() {
 ...
 */
template <int dim, typename Scalar>
void BaseSolverNeoHooke<dim, Scalar>::solve_newton() {
 ...
 */
template <int dim, typename Scalar>
void BaseSolverNeoHooke<dim, Scalar>::output() const {
 ...
 */
template <int dim, typename Scalar>
void BaseSolverNeoHooke<dim, Scalar>::declare_parameters() {
  ...
  prm.enter_subsection("Material");
  {
    prm.declare_entry("mu", "1.0", Patterns::Double(1.0),
                      "mu coefficient of the neo Hooke material");

    prm.declare_entry("lambda", "1.0", Patterns::Double(1.0),
                      "lambda coefficient of the neo Hooke material");
  }
  prm.leave_subsection();
  ...
  prm.enter_subsection("Boundaries");
  {
    ...
    prm.declare_entry("Neumann", "", Patterns::Anything(),
 ...
 */
template <int dim, typename Scalar>
void BaseSolverNeoHooke<dim, Scalar>::parse_parameters(
  ...
  {
    boundaries_utility =
        BoundariesUtility(prm.get("Dirichlet"), prm.get("Neumann"));
  }
  prm.leave_subsection();
...
template class BaseSolverNeoHooke<3, double>;
